...
def default_argument_parser(epilog=None):
    ...
    parser.add_argument(
        "--config-file", default="/home/Pointcept/configs/navarra/pretrain-sonata-v1m2-0-outdoor-navarra-md.py", metavar="FILE", help="path to config file"
    )
    ...
    # semseg-sonata-v1m1-0c-navarra-ft.py  lora
    parser.add_argument(
